...
public class Chequeadapter1 extends RecyclerView.Adapter<Chequeadapter1.ProductViewHolder> {
    ...
    public void onBindViewHolder(final ProductViewHolder holder, int position) {
        ...
        holder.a.setText(cheque.getUser2());
...
holder.del.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        ...
        StringRequest stringRequest = new StringRequest(com.android.volley.Request.Method.POST, "https://androidprojectstechsays.000webhostapp.com/Stock_manegument_system/deletcart.php",
...
//Adding the string request to the queue
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(View itemView) {
            ...
            a= itemView.findViewById(R.id.abc);
